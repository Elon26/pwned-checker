...
const entitlementsFileName = `CredentialProvider.entitlements`;
const plistFileName = `CredentialProvider-Info.plist`;
class NseUpdaterManager {
    ...
    async updateNSEEntitlements(groupIdentifier) {
        ...
        entitlementsFile = entitlementsFile.replace(iosConstants_1.KEYCHAIN_ACCESS_GROUPS_ID_TEMPLATE_REGEX, groupIdentifier);
