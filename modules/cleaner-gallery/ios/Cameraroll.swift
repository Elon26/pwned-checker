...
public class Cameraroll: NSObject {
    ...
    @objc
    func getAssets(params: [String: Any], resolve: @escaping EXPromiseResolveBlock, reject: @escaping EXPromiseRejectBlock) {
    ...
    @objc
    func deleteAssets(ids: [String], resolve: @escaping EXPromiseResolveBlock, reject: @escaping EXPromiseRejectBlock) {
        guard checkPhotoLibraryAccess(reject: reject) else {
            return
        }
    ...
    @objc
    func extractThumbnail(id: String, filename: URL, width: Int, height: Int, resolve: @escaping EXPromiseResolveBlock, reject: @escaping EXPromiseRejectBlock) {
        let fetchResult = PHAsset.fetchAssets(withLocalIdentifiers: [id], options: nil)
    ...
    @objc
    func saveAssets(files: [String], resolve: @escaping EXPromiseResolveBlock, reject: @escaping EXPromiseRejectBlock) {
        guard checkPhotoLibraryAccess(reject: reject) else {
            return
        }
    ...
    func checkPhotoLibraryAccess(reject: EXPromiseRejectBlock?) -> Bool {
